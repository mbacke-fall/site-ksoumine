...
<body>
    ...
    <div class="container-fluid position-relative p-0">
        ...
        <div class="container-fluid py-5" style="margin-bottom: 90px;  background: linear-gradient(rgba(9, 30, 62, .7), rgba(9, 30, 62, .7)), url(img/bg2.jpg) center center no-repeat; background-size: cover;">>
            <div class="row py-5">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="row g-0 mb-3">
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Prix concurrents</h5>
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Equipe professionnelle</h5>
                        </div>
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.4s">
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>24/7 Service client</h5>
                            <h5 class="mb-3"><i class="fa fa-check text-primary me-3"></i>Services innovants</h5>
                        </div>
                    </div>
